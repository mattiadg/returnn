  ...
  def transform_config_dict(cls, d, network, get_layer):
    ...
    if source_data and not source_data.have_time_axis():  # expect to be inside other RecLayer
      ...
      if source_data:
        ...
        target_data = cls._static_get_target_value(
          target=d["target"], mark_data_key_as_used=True, network=network)
        assert target_data.have_time_axis()
        time_dim_tag = target_data.get_time_dim_tag()
      else:
  ...
  def get_output(self):
    ...
    with tf.name_scope("output"):
      ...
      if output_layer:
        ...
        self.time_dim_tag.set_tag_on_size_tensor(output_data.size_placeholder[0])
        ...
        self.time_dim_tag.set_tag_on_size_tensor(seq_len)
